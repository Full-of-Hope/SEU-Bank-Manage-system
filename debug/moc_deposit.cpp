...
QT_MOC_LITERAL(1, 8, 27), // "on_deposit_okButton_clicked"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 29) // "on_deposit_backButton_clicked"

    },
    "deposit\0on_deposit_okButton_clicked\0"
...
void deposit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        deposit *_t = static_cast<deposit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject deposit::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_deposit.data,
      qt_meta_data_deposit,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *deposit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_deposit.stringdata0))
        return static_cast<void*>(const_cast< deposit*>(this));
